...
beautiful.init("/home/gp/.config/awesome/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control", "Shift"	  }, "Return", function () awful.util.spawn(editor_cmd) end),
    
    awful.key({ modkey, "Control", "Shift"  }, "w", function () awful.util.spawn(browser) end),
--    awful.key({ modkey, "Control", "Shift"  }, "p", function () awful.util.spawn(pythonIde) end),
